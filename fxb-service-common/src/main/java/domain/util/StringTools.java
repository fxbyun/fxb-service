...
public class StringTools {
	 ...
	 * @return
	 *//*
	public static String getPaymentMD5Encode(ChannelProxy proxy, SellClient sellclient, String payAccount,
		...
		md5Data.append(proxy.name());
		md5Data.append(sellclient.name());
		...
		return MD5.encode(md5Data.toString());
	}*/
	 ...
	 * @return
	 */
	/*public static String getPaymentGateWay(ChannelProxy proxy, SellClient sellclient, String payAccount,
			String byAccount, String failUrl, String sucUrl, double amount, String cardNum1, String cardNum2,
			String bank, String doCredit, String cardType, String mobile, String bankCard, String bankco) {
		StringBuffer urlsdb = new StringBuffer();
		try {
			urlsdb.append("channel=").append(proxy.name()).append("&");
			urlsdb.append("sellclient=").append(sellclient.name()).append("&");
